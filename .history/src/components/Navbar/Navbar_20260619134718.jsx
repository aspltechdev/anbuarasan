...
function Navbar() {
  ...
  const handleNavClick = (e, href) => {
    ...
    if (element) {
      ...
      console.warn(`Navbar: no element found with id="${targetId}"`);
    }
  };
      ...
      <div className={`navbar-mobile-menu ${isMobileMenuOpen ? "mobile-menu-active" : ""}`}>
        ...
        <div className="mobile-menu-footer">
          ...
          <div className="mobile-footer-content">
            <p className="mobile-footer-text">Transforming Lives Through</p>
            <p className="mobile-footer-subtext">Consciousness, Wealth & Wellness</p>
          </div>
