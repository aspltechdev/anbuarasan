...
// Inner card-inner replaced with EduFlex bubble layout.
// ============================================
import "./About.css";
import { useEffect, useRef, useState } from "react";
...
function About() {
  ...
  return (
    <section className="about" ref={sectionRef} id="about">
      ...
      {/* ── OUTER: Cinematic Background (unchanged) ── */}
      <div className="about-cinematic-bg">
        <div className="about-glow about-glow-1"></div>
        <div className="about-glow about-glow-2"></div>
        <div className="about-glow about-glow-3"></div>
      ...
      <div className="about-container">
        ...
        {/* ── OUTER: Cinematic card (unchanged class/structure) ── */}
        <div className={`about-cinematic-card ${isVisible ? "visible" : ""}`}>
          <div className="about-card-inner">

            {/* ══════════════════════════════════════════
                INNER LEFT — EduFlex floating image bubbles
                (replaces the old about-visual-story block)
            ══════════════════════════════════════════ */}
            <div className="eduflex-bubbles" style={calcParallax(0.015)}>

              {/* Bubble 1 — large, top-left, gold tint */}
              <div className="ef-bubble ef-b1">
                <img
                  src="https://images.unsplash.com/photo-1545389336-cf090694435e?w=480&h=520&fit=crop&crop=face"
                  alt="Anbuarasan"
                />
                <span className="ef-chip ef-arrow">↗</span>
              </div>

              {/* Bubble 2 — small, top-right, lavender tint */}
              <div className="ef-bubble ef-b2">
                <img
              ...
              {/* Bubble 3 — medium, bottom-center, sand tint */}
              <div className="ef-bubble ef-b3">
                <img
                  src="https://images.unsplash.com/photo-1517841905240-472988babdf9?w=380&h=340&fit=crop&crop=face"
                  alt="Wellness journey"
                />
                <span className="ef-chip ef-badge">◈ Holistic Growth</span>
              </div>

              {/* EduFlex-style hollow ring dots */}
              <div className="ef-dot ef-dot-1" />
              <div className="ef-dot ef-dot-2" />

              {/* EduFlex sparkles */}
              <span className="ef-spark ef-spark-1">✦</span>
              <span className="ef-spark ef-spark-2">◆</span>

            </div>

            {/* ══════════════════════════════════════════
                INNER RIGHT — Content (unchanged from original)
            ══════════════════════════════════════════ */}
            <div className="about-story-content">
              <div className="about-content-inner">
