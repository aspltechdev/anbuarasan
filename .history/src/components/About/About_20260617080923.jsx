        ...
        <div className={`about-cinematic-card ${isVisible ? "visible" : ""}`}>
          <div className="about-card-inner">
            ...
            <div className="about-visual-panel">
              ...
              >
                {/*
                  Replace src with your video file, e.g.:
                  src="/assets/nature-loop.mp4"
                  Using a public domain sample as placeholder.
                */}
                <source
                  src="https://cdn.coverr.co/videos/coverr-calm-ocean-waves-1573/1080p.mp4"
                  type="video/mp4"
                />
              </video>

              {/* Video overlay for glass effect */}
              <div className="about-panel-overlay"></div>

              {/* Mosaic cards */}
              <div
                className="about-mosaic"
                style={calcParallax(0.012)}
              >
                <div className="about-mosaic-bg"></div>

                {/* Large card — top-left */}
                <div className="about-mosaic-card about-mosaic-card-lg">
                  <img src={yogaImg} alt="Anbuarasan" />
