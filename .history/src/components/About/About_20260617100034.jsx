    ...
    <section className="about" ref={sectionRef} id="about">
      ...
      <div className="about-container">
        ...
        <div className={`about-cinematic-card ${isVisible ? "visible" : ""}`}>
          ...
          {/* ══ VIDEO sits BEHIND the entire card — both left & right ══ */}
          <video
          ...
          >
            ...
            */}
            <source
              src="https://assets.mixkit.co/videos/preview/mixkit-woman-meditating-in-a-forest-163-large.mp4"
              type="video/mp4"
            />
          </video>

          {/* Frost grain over the whole card */}
          <div className="about-card-grain"></div>

          {/* Grid sits on top — both panels are transparent */}
          <div className="about-card-inner">

            {/* ════ LEFT PANEL — frost tint + mosaic ════ */}
            <div className="about-visual-panel">
              {/* Left-side tint layer */}
            ...
            {/* ════ RIGHT PANEL — glass text content ════ */}
            <div className="about-story-content">
              {/* Right side gets slightly more tint so text stays readable */}
              <div className="about-right-tint"></div>
