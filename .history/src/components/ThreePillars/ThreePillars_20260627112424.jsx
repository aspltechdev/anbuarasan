...
//                   opacity: activePillar === index ? 0.8 : 0.2
//                 }}
//               ></div>
...
//                 style={{ 
//                   borderColor: activePillar === index ? `${pillar.color}50` : `${pillar.color}10`,
  ...
  const pillars = [
    {
      ...
      essence: "Know Thy Self",
      features: ["Self Awareness", "Mindful Presence", "Inner Peace"],
      // Indian meditation / yoga image
      bgImage: "https://images.unsplash.com/photo-1695795910772-6336b0beba36?q=80",
    },
    {
      icon: "✦",
      title: "Conscious Abundance",
      ...
      essence: "Embrace Abundance",
      features: ["Financial Wisdom", "Wealth Mindset", "Prosperity Flow"],
      // Indian temple / prosperity image
      bgImage: "https://images.unsplash.com/photo-1524863479829-916d8e77f114?q=80",
    },
    {
      icon: "⟐",
      title: "Holistic Wellness",
      ...
      essence: "Harmonize Being",
      features: ["Natural Living", "Vitality & Health", "Life Balance"],
      // Indian nature / wellness image
      bgImage: "https://images.unsplash.com/photo-1531714680149-1bde6d4d4c5c?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
