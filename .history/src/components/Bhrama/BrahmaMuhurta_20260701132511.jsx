...
function BrahmaMuhurta() {
  ...
  const courses = [
    { title: "Be a Wonderful Creator", tag: "Beginner", icon: "✦", gradient: "linear-gradient(135deg, #d9c4a3, #8b7355)" },
    { title: "Kriya Tools & Tech", tag: "Beginner", icon: "⟐", gradient: "linear-gradient(135deg, #c9a876, #6b5a3e)" },
    { title: "Art of Attracting Money", tag: "Intermediate", icon: "◈", gradient: "linear-gradient(135deg, #e0c9a6, #a17d4f)" },
    { title: "Law of Transmutation", tag: "Advanced", icon: "☀", gradient: "linear-gradient(135deg, #cbb08a, #5a4a32)" },
  ];
