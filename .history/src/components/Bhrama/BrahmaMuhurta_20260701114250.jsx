...
function BrahmaMuhurta() {
  ...
  // Ref: Brahma Muhurta Kriya practice sheet
  const kriyaSteps = [
    "Aum Chanting",
  ...
  // Ref: Courses list from practice sheet
  const courses = [
          ...
          <div className="brahma-left-light" style={calcParallax(0.004)}>
            <div className="brahma-content-light">
              ...
              <div className="brahma-badge-light">
                ...
                <span className="brahma-badge-text-light">Morning Practice Community</span>
                <span className="brahma-badge-line-light"></span>
              </div>
              ...
              {/* Kriya Steps - ref: practice sheet */}
...
>
  <span className="brahma-cta-text-light">Begin Your Morning Practice
    <br />
  ...
  <span className="brahma-cta-arrow-light">→</span>
        ...
        {/* COURSES SECTION - inline CSS, separate from main content */}
        <div
          style={{
            marginTop: "5rem",
            padding: "3rem 2rem",
