...
import course1 from "../../assets/f1.jpg";
import course2 from "../../assets/f1.jpg";
import course3 from "../../assets/f1.jpg";
import course4 from "../../assets/f1.jpg";
...
function BrahmaMuhurta() {
  ...
  const courses = [
  { title: "Be a Wonderful Creator", tag: "Beginner", icon: "✦", image: course1, gradient: "linear-gradient(135deg, rgba(217,196,163,0.5), rgba(139,115,85,0.7))" },
  { title: "Kriya Tools & Tech", tag: "Beginner", icon: "⟐", image: course2, gradient: "linear-gradient(135deg, rgba(201,168,118,0.5), rgba(107,90,62,0.7))" },
  { title: "Art of Attracting Money", tag: "Intermediate", icon: "◈", image: course3, gradient: "linear-gradient(135deg, rgba(224,201,166,0.5), rgba(161,125,79,0.7))" },
  { title: "Law of Transmutation", tag: "Advanced", icon: "☀", image: course4, gradient: "linear-gradient(135deg, rgba(203,176,138,0.5), rgba(90,74,50,0.7))" },
];
  ...
  return (
    <section className="brahma" ref={sectionRef}>
      ...
      <div className="brahma-container-light">
        ...
        {/* COURSES SECTION */}
        <div className="brahma-courses-wrap-light">
          <h2 className="brahma-courses-heading-light">Courses</h2>
          <div className="brahma-courses-underline-light"></div>

          <div className="brahma-courses-grid-light">
            {courses.map((course, i) => (
              <div key={i} className="brahma-course-card-light">
                <div
                  className="brahma-course-media-light"
                ...
                <div className="brahma-course-body-light">
                  ...
                  <button className="brahma-course-btn-light">Start Learning</button>
                </div>
              </div>
            ))}
          </div>
