...
<section
      style={{
        ...
        background: `url(${creambg1}) center 30% / cover no-repeat`,
      }}
    >
      {/* overlay */}
      <div
  ...
  inset: 0,
  background:
    "linear-gradient(135deg, rgba(30,22,15,0.75), rgba(85,65,40,0.35), rgba(0,0,0,0.25))",
}}
      />
