...
<section className="service-finance">
  ...
  <div className="service-finance-row">
    ...
    <div className="service-finance-grid digital-grid">
      {[
        { title: "Bitcoin", desc: "Understanding the world's first decentralized digital currency and its underlying technology.", image: "/src/assets/crypto.png", accent: "#c9b8a0" },
