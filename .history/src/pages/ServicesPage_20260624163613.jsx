    ...
    <div className="services-page">
      ...
      <section className="service-section">
        ...
        <div className="service-content">
          ...
          <p>
            Learn practical money management, wealth creation
            and conscious financial decision-making strategies.
          </p>
      ...
      <section className="service-section reverse">
        <div className="service-image">
          <img src="/src/assets/strengths.jpg" alt="Wellness Coaching" />
        </div>
        ...
        <div className="service-content">
          ...
          <p>
            Holistic wellness guidance integrating physical,
            mental and emotional wellbeing for lasting
            transformation.
          </p>
