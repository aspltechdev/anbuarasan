...
// Indian-relevant background images
const heroImg = "https://images.unsplash.com/photo-1545558014-8692077e9b5c?w=1600&q=80";       // Yoga/meditation sunrise India
const missionImg = "https://images.unsplash.com/photo-1604881991720-f91add269bed?w=800&q=80";  // Diya lamp flame closeup
const visionImg = "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80";      // Temple/spiritual India
const valuesBgImg = "https://images.unsplash.com/photo-1591474200742-8e512e6f98f8?w=1600&q=80"; // Indian lotus/nature
  ...
  return (
    <div className="about-page">
      ...
      <section className="vision-section">
        <div className="vision-card" style={{ backgroundImage: `url(${missionImg})` }}>
        ...
        <div className="vision-card" style={{ backgroundImage: `url(${visionImg})` }}>
          <div className="vision-card-overlay" />
          <div className="vision-card-body">
            <h2>Vision</h2>
            <p>
      ...
      {/* Values */}
      <section className="values-section" style={{ backgroundImage: `url(${valuesBgImg})` }}>
